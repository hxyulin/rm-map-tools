...
fn main()->anyhow::Result<()> {
 ...
 println!("{}",terrain.describe(0));println!("ground_triangles {} fixtures_triangles {} equipment_triangles {}",terrain.ground.triangles.len(),terrain.fixtures.triangles.len(),terrain.equipment.iter().map(|m|m.triangles.len()).sum::<usize>());
