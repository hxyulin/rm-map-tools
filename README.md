...
The guides also build as a VitePress site with interactive model controls. Run `npm ci` and `npm run docs:dev`, or see [site setup and GitHub Pages deployment](docs/site.md).
