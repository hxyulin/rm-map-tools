...
|---|---|---|
| RMUC 2026 Field in 3D (V2.0.0) | Orbitable mesh of the whole field; arena tinted by height (the file has only cream), equipment in its 30 exported colours | `python/preview/v20.json` |
| RMUC 2026 V1.2.0 Field Colours | Same pipeline on V1.2.0, opening in the exported per-face colours (white, beige, red, navy, dark grey) | `python/preview/v12.json` |
